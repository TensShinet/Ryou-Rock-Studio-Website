<%@page language="java" import="java.util.* ,java.awt.*,javax.servlet.*"
	pageEncoding="UTF-8"%>
<%@ page import="net.rrs.web.model.AccountBean" %><!--导入AccountBean包-->
<!DOCTYPE html>
<head>
<title>山大博雅通cms登录系统</title>
				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="validate.jsp" method="post">
						<fieldset>
							...
							<label class="remember" for="remember"><input type="checkbox" id="remember" />保持登录状态</label>
